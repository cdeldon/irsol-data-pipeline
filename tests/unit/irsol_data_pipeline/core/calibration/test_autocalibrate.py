...
class TestAutocalibrate:
    ...
    def test_calibrate_measurement(self, stokes: StokesParameters):
        ...
        assert result.pixel_scale == 0.023448466826962687
        assert result.wavelength_offset == 5872.047381861239
        assert result.pixel_scale_error == 0.00017740790053598606
        assert result.wavelength_offset_error == 0.08647920052112987
